...
<head>
  ...
  <style>
    /* Página do tamanho real do cupom (80mm). Sem isso o xhtml2pdf gera A4
       e a impressora térmica encolhe/centraliza, deixando um espaço em
       branco enorme no topo do cupom. */
    @page {{
      size: 80mm 297mm;
      margin: 2mm;
    }}
...
<body>
  ...
  <div class="group-section">
    ...
    <div class="item-row">
      <div class="flex">
        <span>{qty}x</span>
        <span style="flex: 1; margin: 0 4px;">{name}</span>
